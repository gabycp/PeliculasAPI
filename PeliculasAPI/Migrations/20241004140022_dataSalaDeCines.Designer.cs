...
namespace PeliculasAPI.Migrations
{
    ...
    [Migration("20241004140022_dataSalaDeCines")]
    partial class dataSalaDeCines
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeliculasAPI.Entidades.PeliculasSalaDeCines", b =>
                {
                    b.Property<int>("PeliculaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasAPI.Entidades.SalaDeCine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-73.986227 40.739898)")
                        });
                });
            ...
            modelBuilder.Entity("PeliculasAPI.Entidades.PeliculasActores", b =>
                {
                    ...
                    b.HasOne("PeliculasAPI.Entidades.Peliculas", "Pelicula")
                        .WithMany("peliculasActores")
